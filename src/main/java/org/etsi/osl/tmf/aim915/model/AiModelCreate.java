...
public class AiModelCreate {
   ...
   */
  public AiModelCreate(AiModelSpecification aiModelSpecification, List<SoftwareRef> software, ServiceStateType state) {
  ...
  public AiModelCreate feature(List<Feature> feature) {
  ...
  public AiModelCreate note(List<Note> note) {
    this.note = note;
    return this;
  }
  ...
  public AiModelCreate place(List<RelatedPlaceRefOrValue> place) {
    this.place = place;
    return this;
  }
  ...
  public AiModelCreate relatedEntity(List<RelatedEntityRefOrValue> relatedEntity) {
  ...
  public AiModelCreate relatedParty(List<RelatedParty> relatedParty) {
  ...
  public AiModelCreate serviceCharacteristic(List<Characteristic> serviceCharacteristic) {
  ...
  public AiModelCreate serviceOrderItem(List<RelatedServiceOrderItem> serviceOrderItem) {
  ...
  public AiModelCreate serviceRelationship(List<ServiceRelationship> serviceRelationship) {
  ...
  public AiModelCreate software(List<SoftwareRef> software) {
    this.software = software;
    return this;
  }
  ...
  public AiModelCreate supportingResource(List<ResourceRef> supportingResource) {
  ...
  public AiModelCreate supportingService(List<ServiceRefOrValue> supportingService) {
