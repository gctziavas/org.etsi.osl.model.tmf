...
public class AiContractSpecificationUpdate {
  ...
  public AiContractSpecificationUpdate attachment(List<AttachmentRefOrValue> attachment) {
  ...
  public AiContractSpecificationUpdate constraint(List<ConstraintRef> constraint) {
  ...
  public AiContractSpecificationUpdate entitySpecRelationship(List<EntitySpecificationRelationship> entitySpecRelationship) {
  ...
  public AiContractSpecificationUpdate relatedParty(List<RelatedParty> relatedParty) {
  ...
  public AiContractSpecificationUpdate specCharacteristic(List<CharacteristicSpecification> specCharacteristic) {
