...
public class AiContract {
  ...
  public AiContract characteristic(List<Characteristic> characteristic) {
  ...
  public AiContract relatedParty(List<RelatedParty> relatedParty) {
  ...
  public AiContract rule(List<Rule> rule) {
    this.rule = rule;
    return this;
  }
